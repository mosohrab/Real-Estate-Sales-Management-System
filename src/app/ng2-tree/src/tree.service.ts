...
export class TreeService {
  ...
  // public nodeCreated$: Subject<{ NodeCreatedEvent, NodeMenuItemAction }> =
  // new Subject<{ NodeCreatedEvent, NodeMenuItemAction }>();
  ...
  public fireNodeCreated(tree: Tree, menu: NodeMenuItemAction): void {
  
    this.nodeCreated$.next( new NodeCreatedEvent(tree, menu));
  }
