...
@Component({
  ...
  <ul class="tree" *ngIf="tree" [ngClass]="{rootless: isRootHidden()}">
    <li>
      ...
      <node-menu *ngIf="isRightMenuVisible" 
      [menuItems]="menuItems"
...
export class TreeInternalComponent implements OnInit, OnChanges, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.menuItems = this.tree.menuItems;
  ...
  public onMenuItemSelected(e: NodeMenuItemSelectedEvent): void {
    ...
    switch (e.nodeMenuItemAction) {
      ...
      // case NodeMenuItemAction.NewCompany:
      // case NodeMenuItemAction.NewPhase:
      // case NodeMenuItemAction.NewProject:
  ...
  private onNewSelected(e: NodeMenuItemSelectedEvent): void {
    ...
    const tree = this.tree.createNode(e,
      e.nodeMenuItemAction === NodeMenuItemAction.NewFolder);
    this.isRightMenuVisible = false;
    this.isLeftMenuVisible = false;
  }
  ...
  public applyNewValue(e: NodeEditableEvent): void {
    ...
    if (this.tree.isNew()) {
      ...
      this.treeService.fireNodeCreated(this.tree, null);
    }
